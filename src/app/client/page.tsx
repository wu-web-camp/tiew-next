    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-[#A54141] mb-4">
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-bold text-[#A54141] mb-6">
          ...
          <Link href="#" className="inline-flex items-center px-8 py-4 bg-[#A54141] text-white font-semibold rounded-lg hover:bg-[#A54141]/80 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
            Get Started
