  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userExists) {
        setMessage({
          type: "error",
          text: "ชื่อผู้ใช้หรืออีเมลนี้มีอยู่ในระบบแล้ว",
        });
        setIsSubmitting(false);
        return;
      }
      ...
      setMessage({
        type: "success",
        text: "สมัครสมาชิกสำเร็จ! กำลังนำคุณไปยังหน้าหลัก...",
      });
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-red-600 to-[#A54141] px-6 py-8 text-center">
            <h1 className="text-3xl font-bold text-white font-thai">
              สมัครสมาชิก
            </h1>
          </div>
          ...
          <div className="px-6 py-8">
            ...
            {message && (
              <div
                className={`mb-6 p-4 rounded-lg font-thai ${
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label
                  ...
                  className="block text-sm font-medium text-gray-700 mb-2 font-thai"
                >
                  รูปโปรไฟล์
                </label>
