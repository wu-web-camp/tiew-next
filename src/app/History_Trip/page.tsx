...
const tripHistory = [
    {
        ...
        rating: 5,
        review: "Amazing experience! The temples were breathtaking and the food was incredible."
    },
    {
        id: 2,
    ...
    },
    {
        ...
        rating: 3,
        review: "Good for a short getaway. The nightlife was fun but quite crowded."
    }
];
            ...
            <div className="max-w-7xl mx-auto py-20 px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                        ดูประวัติการจองทริปทั้งหมดของคุณ พร้อมรีวิวและคะแนนจากการเดินทางที่ผ่านมา
                    </p>
                </div>
