...
export default function GalleryTrip() {
  const destinations = [
    ...
    },
    {
      ...
      name: "หาดไร่เลย์",
      image:
        "https://www.ananda.co.th/blog/thegenc/wp-content/uploads/2024/03/934-x-550-px-15.png",
    ...
    },
    {
      ...
      name: "ดอยอ่างขาง",
      image:
        "https://www.ananda.co.th/blog/thegenc/wp-content/uploads/2024/03/934-x-550-px-24.png",
      orientation: "horizontal", // 4:3
    },
    {
      id: 8,
    ...
    },
    {
      ...
      name: "ภูชี้ฟ้า",
      image:
        "https://www.ananda.co.th/blog/thegenc/wp-content/uploads/2024/03/934-x-550-px-26.png",
      orientation: "vertical", // 3:4
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {destinations.map((destination) => (
            <div
              key={destination.id}
              className={`group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:scale-105 ${getGridSpan(
                destination.orientation
              )} ${getMinHeight(destination.orientation)}`}
            >
              <Image
