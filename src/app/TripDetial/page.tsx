...
const tripDetail = {
  ...
  description:
    "สัมผัสเสน่ห์ของกรุงเทพมหานครที่ผสมผสานความทันสมัยและวัฒนธรรมดั้งเดิมเข้าด้วยกัน ท่องเที่ยววัดสวยงาม ลิ้มรสอาหารแสนอร่อย และช้อปปิ้งในตลาดนัดสุดฮิต",
  highlights: [
  ...
  reviews: [
    {
      ...
      date: "2024-07-10",
      comment:
        "ทริปที่ยอดเยี่ยมมาก! ไกด์ดีมาก อาหารอร่อย วัดสวยงาม แนะนำเลยครับ",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      date: "2024-07-06",
      comment:
        "ครั้งแรกที่มากรุงเทพ ทีมงานดูแลดีมาก ได้ความรู้เยอะ คุ้มค่าเงินครับ",
    },
  ],
};
        ...
        <div className="mb-8">
          <div className="relative overflow-hidden rounded-3xl shadow-2xl mb-4">
            ...
            <button
              onClick={() =>
                setCurrentImageIndex((prev) =>
                  prev > 0 ? prev - 1 : tripDetail.images.length - 1
                )
              }
            ...
            <button
              onClick={() =>
                setCurrentImageIndex((prev) =>
                  prev < tripDetail.images.length - 1 ? prev + 1 : 0
                )
              }
            ...
            <div className="lg:text-right">
              <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-white rounded-2xl p-6">
                ...
                <div className="text-3xl font-bold mb-2">
                  ฿{tripDetail.price.toLocaleString()}
                </div>
                <div className="text-sm opacity-90">
                  <span className="line-through">
                    ฿{tripDetail.originalPrice.toLocaleString()}
                  </span>
            ...
            {activeTab === "itinerary" && (
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-gray-800 mb-6">
                  รายการการเดินทาง 5 วัน 4 คืน
                </h3>
                {tripDetail.itinerary.map((day) => (
                  <div
                    key={day.day}
                    className="border-l-4 border-red-400 pl-6 pb-8"
                  >
                    <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {tripDetail.hotel.facilities.map(
                            (facility, index) => (
                              <span
                                key={index}
